...
const MoviePage = ({movieFullInfo, reviews, films, onMovieCardClick, onModalShow, modalShow, movieId}) => {
            ...
            <div className="movie-card__wrap">
              <div className="movie-card__desc">
                ...
                <div className="movie-card__buttons">
                  <button className="btn btn--play movie-card__button" type="button" onClick={onModalShow}>
